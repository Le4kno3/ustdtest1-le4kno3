...
exports.createTransactionEvent = exports.createBlockEvent = exports.isZeroAddress = exports.formatAddress = exports.keccak256 = exports.assertShellResult = exports.assertIsNonEmptyString = exports.assertExists = exports.getJsonFile = void 0;
...
var createTransactionEvent = function (transaction, block, networkId, traces, logs) {
    ...
    if (exports.isZeroAddress(transaction.to)) {
        contractAddress = exports.formatAddress(address_1.getContractAddress({ from: transaction.from, nonce: transaction.nonce }));
    }
