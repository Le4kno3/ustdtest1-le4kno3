...
function configureContainer(args) {
    ...
    var bindings = {
        ...
        cliCommandName: awilix_1.asValue(args.cliCommandName),
        ...
        sleep: awilix_1.asValue(function (durationMs) { return new Promise(function (resolve) { return setTimeout(resolve, durationMs); }); }),
        args: awilix_1.asValue(args),
        contextPath: awilix_1.asValue(args.contextPath || process.cwd()),
        ...
        packageJson: awilix_1.asFunction(function (contextPath) {
            try {
                var packageJsonPath = path_1.join(contextPath, "package.json");
        ...
        documentation: awilix_1.asFunction(function (contextPath) { return path_1.join(contextPath, 'README.md'); }).singleton(),
        ...
        agentPath: awilix_1.asFunction(function (contextPath) {
            var agentPath = path_1.join(contextPath, "src", "agent");
            if (fs_1.default.existsSync(path_1.join(contextPath, "src", "agent.ts"))) {
                var tsConfigPath = path_1.join(contextPath, "tsconfig.json");
                var compilerOptions = jsonc_1.jsonc.parse(fs_1.default.readFileSync(tsConfigPath, 'utf8')).compilerOptions;
                agentPath = path_1.join(contextPath, compilerOptions.outDir, "agent");
            }
            else if (fs_1.default.existsSync(path_1.join(contextPath, "src", "agent.py"))) {
                agentPath = path_1.join(contextPath, "src", "agent.py");
            }
            return agentPath;
        }),
        ...
        initKeystore: awilix_1.asFunction(init_keystore_1.default),
        initKeyfile: awilix_1.asFunction(init_keyfile_1.default),
        initConfig: awilix_1.asFunction(init_config_1.default),
        ...
        getLogsForBlock: awilix_1.asFunction(get_logs_for_block_1.default),
