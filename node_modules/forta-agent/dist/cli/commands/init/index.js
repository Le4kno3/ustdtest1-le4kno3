...
function provideInit(shell, prompt, filesystem, contextPath, initKeystore, initConfig, initKeyfile, args) {
    ...
    utils_1.assertIsNonEmptyString(contextPath, 'contextPath');
    utils_1.assertExists(initKeystore, 'initKeystore');
    utils_1.assertExists(initConfig, 'initConfig');
    utils_1.assertExists(initKeyfile, 'initKeyfile');
    utils_1.assertExists(args, 'args');
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!filesystem.existsSync(contextPath)) {
                            ...
                            utils_1.assertShellResult(createContextPathResult, "error creating project folder " + contextPath);
                        }
                    ...
                    case 5:
                        ...
                        utils_1.assertShellResult(npmInstallResult, "error installing npm dependencies");
