...
function provideRunLive(ethersProvider, runHandlersOnBlock, sleep) {
    ...
    return function runLive(shouldContinuePolling) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var currBlockNumber, latestBlockNumber;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!shouldContinuePolling()) return [3, 7];
