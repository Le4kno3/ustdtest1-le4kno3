...
var Finding = (function () {
    function Finding(name, description, alertId, protocol, severity, type, metadata, addresses) {
        this.name = name;
    ...
    Finding.fromObject = function (_a) {
        var name = _a.name, description = _a.description, alertId = _a.alertId, _b = _a.protocol, protocol = _b === void 0 ? 'ethereum' : _b, severity = _a.severity, type = _a.type, _c = _a.metadata, metadata = _c === void 0 ? {} : _c, _d = _a.addresses, addresses = _d === void 0 ? [] : _d;
